...
class ChefTest < ActiveSupport::TestCase
    ...
    test "emails should be rejected when in invalid format" do
        invalid_emails = %w[sddsds mashrur@exa,com mmm@foo+bar.com]
    ...
    test "email should be lower case before reaching DB" do
